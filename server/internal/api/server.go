...
func (s *Server) Handler() http.Handler {
	...
	router.HandleFunc("POST /api/v1/devices/qr-pairings", s.createQRPairing)
	router.HandleFunc("POST /api/v1/devices/qr-pairings/{sessionId}/pair", s.pairQRDevice)
	router.HandleFunc("DELETE /api/v1/devices/qr-pairings/{sessionId}", s.cancelQRPairing)
